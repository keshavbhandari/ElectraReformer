    ...
    def __init__(
        ...
        *,
        ...
        if emb_type == "default":
            ...
            self.token_emb = QREmbeddingBag(num_categories=num_tokens, embedding_dim=dim,
                                            num_collisions=num_collisions)
        elif emb_type == "md":
            self.token_emb = PrEmbeddingBag(num_embeddings=num_tokens, proj_embedding_dim=dim // 2,
                                            base_dim=dim)
        else:
